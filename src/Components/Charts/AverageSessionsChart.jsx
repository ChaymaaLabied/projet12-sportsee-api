...
export default function AverageSessionsChart({ userAverageSessions }) {
  ...
  return (
    <div className="averageSessionsChart">
      ...
      <ResponsiveContainer width="100%" height="100%" className="LineChart-responsive">
        <LineChart
          ...
          onMouseMove={(e) => {
            ...
            const div = document.getElementsByClassName('LineChart-responsive')[0];
            if (e.isTooltipActive) {
              const windowWidth = div.clientWidth; // Largeur du conteneur
              const mouseXpercentage = Math.round((e.activeCoordinate.x / windowWidth) * 100); // Pourcentage de la position x de la souris
